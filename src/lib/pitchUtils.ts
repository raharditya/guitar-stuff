const noteFreqs = [
  ...
  { note: "F♯_G♭", freq: [92.5, 185.0, 369.99] },
  { note: "G", freq: [98.0, 196.0, 392.0] },
  { note: "G♯_A♭", freq: [103.83, 207.65, 415.3] },
  { note: "A", freq: [110.0, 220.0, 440.0] },
  { note: "A♯_B♭", freq: [116.54, 233.08, 466.16] },
  { note: "B", freq: [123.47, 246.94, 493.88] },
  { note: "C", freq: [130.81, 261.63, 523.25] },
  { note: "C♯_D♭", freq: [138.59, 277.18, 554.37] },
  { note: "D", freq: [146.83, 293.66, 587.33] },
  { note: "D♯_E♭", freq: [155.56, 311.13, 622.25] },
];
